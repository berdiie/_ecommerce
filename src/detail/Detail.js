...
useEffect(()=>{
  axios.get(`https://fakestoreapi.com/products/${ui}`).then((data)=>{
...
console.log(value.image);
  ...
  <div className="row px-xl-5">
    <div className="col-lg-5 pb-5">
      ...
      >
        <div className="carousel-inner border">
          ...
          <Button onClick={handleOpen}>
            <img className="w-100 h-100" src={value.image} alt="Image" /></Button>
            <Modal
        open={open}
        onClose={handleClose}
      ...
      >
          <Box sx={style}>
          <img className="w-100 h-100" src={value.image} alt="Image" />
      </Box>
      </Modal>
          </div>
